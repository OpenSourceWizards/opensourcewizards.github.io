...
const SocialMediaLink: React.FC<{ image: string; name: string; twitterName: string }> = ({ image, name, twitterName }) => {
  return (
    <div className="flex w-32 flex-col items-center justify-center gap-2">
      ...
      <a href={`https://twitter.com/${twitterName}`} target="_blank" className="w-full">
