...
Crafting locations, items and their ingredients are defined in [data/crafting.lua](https://github.com/opensourcewizards/ox_inventory/blob/main/data/crafting.lua).
