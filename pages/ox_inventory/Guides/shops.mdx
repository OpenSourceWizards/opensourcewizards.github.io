...
Builtin shops are defined in [data/shops.lua](https://github.com/opensourcewizards/ox_inventory/blob/main/data/shops.lua), and more can be added here to benefit from the built-in markers or zones support.
