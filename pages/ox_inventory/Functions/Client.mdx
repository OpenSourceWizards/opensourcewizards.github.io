...
<Tabs items={['Player', 'Shop', 'Stash']}>
  ...
  <Tab>
    Open the fourth "General Store" [location](https://github.com/opensourcewizards/ox_inventory/blob/main/data/shops.lua#L14).
  ...
  <Tab>
    Open the first stash in [data/stashes](https://github.com/opensourcewizards/ox_inventory/blob/main/data/stashes.lua#L2-L19).
...
Returns a table of all registered items. The format is as defined in [data/items.lua](https://github.com/opensourcewizards/ox_inventory/blob/main/data/items.lua).
