...
<ResourceLinks repo="https://github.com/opensourcewizards/oxmysql" />
...
### Download the [latest release](https://github.com/opensourcewizards/oxmysql/releases/latest).
...
- ☐ Multi-statements are disabled for security reasons (see [#102](https://github.com/opensourcewizards/oxmysql/issues/102)).
...
You can use raw exports, or install [our npm package](https://www.npmjs.com/package/@opensourcewizards/oxmysql) for intellisense and similar usage as Lua.

```bash
# With pnpm
pnpm add @opensourcewizards/oxmysql

# With Yarn
yarn add @opensourcewizards/oxmysql

# With npm
npm install @opensourcewizards/oxmysql
```

Import the oxmysql object into your resource.

```js
import { oxmysql as MySQL } from '@opensourcewizards/oxmysql';
```
