...
<ResourceLinks repo="https://github.com/opensourcewizards/ox_target" />
...
### Download a [release](https://github.com/opensourcewizards/ox_target/releases) or clone the source code.

```bash
git clone https://github.com/opensourcewizards/ox_target.git
```
...
- [ox_core](https://github.com/opensourcewizards/ox_core)
