...
<ResourceLinks repo="https://github.com/opensourcewizards/ox_core" />
...
- [ox_appearance](https://github.com/opensourcewizards/ox_appearance)

### Download a [release](https://github.com/opensourcewizards/ox_core/releases) or build the source code.

```bash
git clone https://github.com/opensourcewizards/ox_core.git
cd ox_core/web
pnpm i
pnpm build
```
...
<NpmButton link="https://www.npmjs.com/package/@opensourcewizards/ox_core" />
